...
const Bot = () => {
    ...
    const handleSendMessage = async ()=>{
        ...
        try{
            const response = await axios.post("https://custom-chatbot-1-ndq3.onrender.com/bot/v1/message",{
                text:input
            })

            if(response.status===200){
                setMessage([...message,{text:response.data.userMessage,sender:'user'},{text:response.data.botMessage,sender:'bot'}])
            }
